...
<body>
  <div className="email-container">
    ...
    <div className="content">
      <h2>Hi ${admin.name},</h2>
      <p>
        We’re excited to have you on board as a new admin for <strong>Gstar E-Solution Pvt Ltd</strong>. 
        With your new admin account, you’ll have access to tools and resources to manage and enhance 
        our platform effectively.
      </p>
      <p>
        To get started, please log in to your admin dashboard and explore the features available to you.
      </p>
     ...
     <!--  <p style="text-align: center;">
         <a href="[Admin Dashboard URL]" className="button">Go to Admin Dashboard</a>
       </p> -->
    </div>
    <!-- Footer Section -->
...
exports.getprofile = async (req, res) => {
  try {
    ...
    return res.status(200).json({ admin: user, msg: "Profile retrieved successfully" });
