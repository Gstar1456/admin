...
export default function Uploadpdf() {
    ...
    const fetchproduct = async () => {
        let res = await fetch(`${api}/product/nopdf`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' },
        })
        res = await res.json()
                                                            ...
                                                            <Tooltip title="Edit">
                                                                <IconButton>
                                                                    <button onClick={() => handleShow2(p._id)} className="nobackgr">
                                                                        <a href="#form_container2"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                            ...
                            <tbody>
                                {currentItems.length > 0 && currentItems.map((p, i) => (
                                    ...
                                    <tr className="products" key={i}>
                                        <td>{i+1}
                                            <div className="details">
                                                <p className="pt-0 pb-0">Entry By : {p.entryby}</p>
